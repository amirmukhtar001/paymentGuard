                ...
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <div>
                        <button type="button" class="btn btn-primary"
                            onclick="window.location='{{ route('settings.polls.create') }}'">
                            <i class="bx bx-plus"></i> New Poll
                        </button>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="polls-table" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Actions</th>
                                    <th>Title</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#polls-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('settings.polls.datatable') }}',
                    data: function(d) {
