                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive mb-4">
                                    ...
                                    <table id="myDataTable" class="table table-bordered myDataTable"
                                        data-route="{{ route('settings.unioncouncillors.list') }}"
                                        raw-columns="id,name,ur_name,district.title,action">
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>ID</th>
    ...
    <script>
        $(function() {
            ...
            $('#myDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('settings.unioncouncillors.list') }}",
                    type: "GET",
                    data: function(d) {
                ...
                buttons: [
                    {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                filename: 'union-councils-' + new Date().toISOString().slice(0, 10)
                            },
                            {
                                extend: 'excel',
                ...
                language: {
                    ...
                    emptyTable: 'No union councils found',
                    zeroRecords: 'No matching union councils found'
                },
                responsive: true
            });

            $('.head-label').html('<h5 class="card-title mb-0">Union Councils Listings</h5>');
        });
    </script>
@endpush
