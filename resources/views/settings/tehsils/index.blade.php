                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive mb-4">
                                    ...
                                    <table id="myDataTable" class="table table-bordered myDataTable"
                                        data-route="{{ route('settings.tehsils.list') }}"
                                        raw-columns="id,title,ur_title,district.title,action">
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>ID</th>
    ...
    <script>
        $(function() {
            ...
            $('#myDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('settings.tehsils.list') }}",
                    type: "GET",
                    data: function(d) {
                ...
                buttons: [
                    {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                filename: 'tehsils-' + new Date().toISOString().slice(0, 10)
                            },
                            {
                                extend: 'excel',
                ...
                language: {
                    ...
                    emptyTable: 'No tehsils found',
                    zeroRecords: 'No matching tehsils found'
                },
                responsive: true
            });

            $('.head-label').html('<h5 class="card-title mb-0">Tehsil Listings</h5>');
        });
    </script>
@endpush
