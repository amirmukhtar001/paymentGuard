                ...
                <div class="card-body">
                    <div class="card-datatable table-responsive pt-0">
                        <table id="myDataTable" class="table table-bordered myDataTable"
                            data-route="{{ route('settings.my-roles.list') }}" raw-columns="name,slug,level,action">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>#</th>
    ...
    <script>
        $(function() {
            $('#myDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('settings.my-roles.list') }}",
                    type: "GET",
                    data: function(d) {
                ...
                buttons: [
                    {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                filename: 'roles-' + new Date().toISOString().slice(0, 10)
                            },
                            {
                                extend: 'excel',
                    ...
                    {
                        text: '<i class="bx bx-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">New Role</span>',
                        className: 'btn btn-primary',
                        action: function() {
                            window.location.href = "{{ route('settings.my-roles.create') }}";
                        }
                    }
                ],
                language: {
            ...
            $('.head-label').html('<h5 class="card-title mb-0">Roles List</h5>');
        });
    </script>
@endpush
