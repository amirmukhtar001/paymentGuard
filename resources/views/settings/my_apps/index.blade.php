                            ...
                            <div class="card-body">
                                <div class="table-responsive mb-4">
                                    <table id="myDataTable" class="table table-bordered myDataTable"
                                        data-route="{{ route('settings.my-apps.list') }}"
                                        raw-columns="id,title,route,action">
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>#</th>
    ...
    <script>
        $(function() {
            ...
            $('#myDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('settings.my-apps.list') }}",
                    type: "GET",
                    data: function(d) {
                ...
                buttons: [
                    {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                filename: 'apps-' + new Date().toISOString().slice(0, 10)
                            },
                            {
                                extend: 'excel',
                ...
                language: {
                    ...
                    emptyTable: 'No apps found',
                    zeroRecords: 'No matching apps found'
                },
                responsive: true
            });

            $('.head-label').html('<h5 class="card-title mb-0">My Apps List</h5>');
        });
    </script>
@endpush
