                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive mb-4">
                                    ...
                                    <table id="myDataTable" class="table table-bordered myDataTable"
                                        data-route="{{ route('settings.districts.list') }}"
                                        raw-columns="id,title,province.title,division.title,action">
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>ID</th>
    ...
    <script>
        $(function() {
            ...
            $('#myDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('settings.districts.list') }}",
                    type: "GET",
                    data: function(d) {
                ...
                columns: [
                    ...
                    { data: 'division.title', name: 'division.title' }
                ],
                order: [[2, 'asc']],
                pageLength: 20,
                ...
                buttons: [
                    {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                filename: 'districts-' + new Date().toISOString().slice(0, 10)
                            },
                            {
                                extend: 'excel',
            ...
            $('.head-label').html('<h5 class="card-title mb-0">District Listings</h5>');
        });
    </script>
@endpush
