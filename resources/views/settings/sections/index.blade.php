                ...
                <div class="card-body">
                    <div class="table-responsive" style="min-height: 200px">
                        <table id="myDataTable" class="table table-bordered myDataTable"
                            data-route="{{ route('settings.sections.list') }}" raw-columns="title,parent,attachments,action">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>Title</th>
    ...
    <script>
        $(function() {
            ...
            $('#myDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('settings.sections.list') }}",
                    type: "GET",
                    data: function(d) {
                ...
                buttons: [
                    {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                filename: 'sections-' + new Date().toISOString().slice(0, 10)
                            },
                            {
                                extend: 'excel',
                    ...
                    },
                    {
                        ...
                        action: function() {
                            window.location.href = "{{ route('settings.sections.create') }}";
                        }
                    }
                ],
                language: {
            ...
            $('.head-label').html('<h5 class="card-title mb-0">Sections List</h5>');
        });
    </script>
@endpush
