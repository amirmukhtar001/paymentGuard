                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive mb-4">
                                    ...
                                    <table id="myDataTable" class="table table-bordered myDataTable"
                                        data-route="{{ route('settings.divisions.list') }}"
                                        raw-columns="id,title,ur_title,province.title,action">
                                        <thead>
                                            <tr>
                                                <th width="40%">Action</th>
                                                <th width="10%">ID</th>
                                                <th width="20%">Title</th>
                                                <th width="20%">Urdu Title</th>
    ...
    <script>
        $(function() {
            ...
            $('#myDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('settings.divisions.list') }}",
                    type: "GET",
                    data: function(d) {
                ...
                buttons: [
                    {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                filename: 'divisions-' + new Date().toISOString().slice(0, 10)
                            },
                            {
                                extend: 'excel',
            ...
            $('.head-label').html('<h5 class="card-title mb-0">Division Listings</h5>');
        });
    </script>
@endpush
