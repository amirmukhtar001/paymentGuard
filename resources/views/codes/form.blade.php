            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form method="POST"
                            action="{{ $item->exists
                                ? route('settings.codes.update', $item->uuid)
                                : route('settings.codes.store') }}">
                            @csrf
                            @if($item->exists)
                            @method('PUT')
                            @endif
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="title" class="form-label req">Code Title</label>
                                        <span class="help">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-label">Promulgation Date</label>
                                        <span class="help">
                                            @if(session()->has('errors'))
                                            {!! session()->get('errors')->first('promulgation_date') !!}
                                            @endif
                                        </span>
                                        <input type="date"
                                            name="promulgation_date"
                                            class="form-control"
                                            value="{{ old('promulgation_date', optional($item->promulgation_date)->format('Y-m-d')) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control" required>
                                            {{-- IMPORTANT: keep values aligned with StatusEnum values --}}
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">Code Document / Media</label>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <a href="{{ route('settings.codes.index') }}"
