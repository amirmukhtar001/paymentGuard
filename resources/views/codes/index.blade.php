        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive" style="min-height: 200px">
                    <table id="codes-table" class="table table-bordered table-striped">
                        <thead>
                            <tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        let table = $('#codes-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: '{{ route("settings.codes.datatable") }}',
                data: function(d) {
            ...
            buttons: [{
                text: '<i class="bx bx-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">New Code</span>',
                className: 'btn btn-primary',
                action: function() {
                    window.location.href = "{{ route('settings.codes.create') }}";
                }
            }],

            language: {
                emptyTable: 'No codes found',
                zeroRecords: 'No matching codes found'
            },
