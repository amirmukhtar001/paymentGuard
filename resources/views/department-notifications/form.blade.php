            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form method="POST"
                            action="{{ $item->exists? route('settings.department-notifications.update', $item->uuid) 
                            : route('settings.department-notifications.store') }}">
                            @csrf
                            @if($item->exists)
                            @method('PUT')
                            @endif
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="title" class="form-label req">Notification Title</label>
                                        <span class="help">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="help">
                                            ...
                                            @endif
                                        </span> @include('components.company_field', ['companies' => $companies, 'select_id' => 'company_id', 'label' => 'Web Site'])
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="help">
                                            @if(session()->has('errors'))
                                            {!! session()->get('errors')->first('notification_date') !!}
                                            @endif
                                        </span>
                                        <input type="date"
                                            name="notification_date"
                                            class="form-control"
                                            value="{{ old('notification_date', optional($item->notification_date)->format('Y-m-d')) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="help">
                                            @if(session()->has('errors'))
                                            {!! session()->get('errors')->first('order_number') !!}
                                            @endif
                                        </span>
                                        <input type="number"
                                            name="order_number"
                                            class="form-control"
                                            min="0"
                                            value="{{ old('order_number', $item->order_number ?? 0) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @php
                                        // If you use enum cast, $item->status may be object; handle both
                                        $statusOld = old('status', is_object($item->status ?? null) ? ($item->status->value ?? 'active') : ($item->status ?? 'active'));
                                        @endphp
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">Notification Document / Media</label>
                                ...
                                {{-- (Optional) Description field if you add in DB later 
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description"
                                            class="form-control"
                                            rows="3"
                                            placeholder="Optional (if you add description column)">{{ old('description', $item->description ?? '') }}</textarea>
                                    </div>--}}
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <a href="{{ route('settings.department-notifications.index') }}"
