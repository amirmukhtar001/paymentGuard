...
EventHandler.on(document, EVENT_CLICK_DATA_API$4, SELECTOR_DATA_TOGGLE$4, function (event) {
  ...
  var _iterator1 = _createForOfIteratorHelper(selectorElements),
    _step1;
  try {
  ...
  return _createClass(Dropdown, [{
    ...
    value: function show() {
      ...
      if ('ontouchstart' in document.documentElement && !this._parent.closest(SELECTOR_NAVBAR_NAV)) {
        var _ref6;
        var _iterator10 = _createForOfIteratorHelper((_ref6 = []).concat.apply(_ref6, _toConsumableArray(document.body.children))),
          _step10;
        try {
    ...
    value: function _completeHide(relatedTarget) {
      ...
      if ('ontouchstart' in document.documentElement) {
        var _ref7;
        var _iterator11 = _createForOfIteratorHelper((_ref7 = []).concat.apply(_ref7, _toConsumableArray(document.body.children))),
          _step11;
        try {
  ...
  return _createClass(ScrollBarHelper, [{
    ...
    value: function _setElementAttributes(selector, styleProperty, callback) {
      ...
      var manipulationCallBack = function manipulationCallBack(element) {
        if (element !== _this15._element && window.innerWidth > element.clientWidth + scrollbarWidth) {
          return;
        }
        _this15._saveInitialAttribute(element, styleProperty);
...
var Backdrop = /*#__PURE__*/function (_Config3) {
  function Backdrop(config) {
    ...
    _this16 = _callSuper(this, Backdrop);
    _this16._config = _this16._getConfig(config);
    _this16._isAppended = false;
    _this16._element = null;
    return _this16;
  } // Getters
...
var FocusTrap = /*#__PURE__*/function (_Config4) {
  function FocusTrap(config) {
    ...
    _this19 = _callSuper(this, FocusTrap);
    _this19._config = _this19._getConfig(config);
    _this19._isActive = false;
    _this19._lastTabNavDirection = null;
    return _this19;
  } // Getters
...
function sanitizeHtml(unsafeHtml, allowList, sanitizeFunction) {
  ...
  try {
    for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
      ...
      var attributeList = (_ref0 = []).concat.apply(_ref0, _toConsumableArray(element.attributes));
  ...
  return _createClass(TemplateFactory, [{
    ...
    value: function toHtml() {
      ...
      for (var _i8 = 0, _Object$entries2 = Object.entries(this._config.content); _i8 < _Object$entries2.length; _i8++) {
        var _ref1 = _Object$entries2[_i8];
        var _ref10 = _slicedToArray(_ref1, 2);
        var selector = _ref10[0];
        var text = _ref10[1];
    ...
    value: function _checkContent(arg) {
      for (var _i9 = 0, _Object$entries3 = Object.entries(arg); _i9 < _Object$entries3.length; _i9++) {
        var _ref11 = _Object$entries3[_i9];
        var _ref12 = _slicedToArray(_ref11, 2);
        var selector = _ref12[0];
        var content = _ref12[1];
...
var Tooltip = /*#__PURE__*/function (_BaseComponent8) {
  function Tooltip(element, config) {
    ...
    _this37 = _callSuper(this, Tooltip, [element, config]); // Private
    ...
    _this37._newContent = null; // Protected
  ...
  return _createClass(Tooltip, [{
    ...
    value: function show() {
      ...
      if ('ontouchstart' in document.documentElement) {
        var _ref13;
        var _iterator18 = _createForOfIteratorHelper((_ref13 = []).concat.apply(_ref13, _toConsumableArray(document.body.children))),
          _step18;
        try {
    ...
    value: function hide() {
      ...
      if ('ontouchstart' in document.documentElement) {
        var _ref14;
        var _iterator19 = _createForOfIteratorHelper((_ref14 = []).concat.apply(_ref14, _toConsumableArray(document.body.children))),
          _step19;
        try {
    ...
    value: function _getConfig(config) {
      ...
      for (var _i0 = 0, _Object$keys5 = Object.keys(dataAttributes); _i0 < _Object$keys5.length; _i0++) {
        var dataAttribute = _Object$keys5[_i0];
...
var ScrollSpy = /*#__PURE__*/function (_BaseComponent9) {
  function ScrollSpy(element, config) {
    ...
    _this45 = _callSuper(this, ScrollSpy, [element, config]); // this._element is the observablesContainer and config.target the menu links wrapper
...
var Tab = /*#__PURE__*/function (_BaseComponent0) {
  function Tab(element) {
    ...
    if (!_this49._parent) {
      return _possibleConstructorReturn(_this49); // todo: should Throw exception on v6
