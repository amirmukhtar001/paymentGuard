...
class UpdateDepartmentNotificationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $notification = $this->route('department_notification') ?? $this->route('departmentNotification') ?? $this->route('notification');
        ...
        return [
            ...
            'slug'  => [
                ...
                'string',
                'max:255',
                Rule::unique('department_notifications', 'slug')->ignore($notificationId),
            ],
    ...
    public function prepareForValidation(): void
    {
        $this->merge([
            ...
            'order_number' => $this->input('order_number') !== null
                ? (int) $this->input('order_number')
                : 0,
