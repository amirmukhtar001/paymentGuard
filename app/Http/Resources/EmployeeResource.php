...
class EmployeeResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        // ================= MEDIA =================
        $pictureUrl = ($pictureMedia && $pictureMedia->file_path)
            ? $this->getMediaUrl($pictureMedia)
            : null;

        $notificationUrl = ($notification && $notification->file_path)
        ...
        $history = $this->whenLoaded('histories', function () {
            return $this->histories->map(function ($h) {
                ...
                return [
                    'working_from' => $h->working_from
                        ? $h->working_from->format('d M Y')
                        : null,

                    'working_till' => $h->working_till
        ...
        return [
            ...
            // ================= MEDIA =================
            'picture' => $pictureUrl,
            'notification_media' => $notificationUrl,
